...
Or after you plugged in the flash-drive press "Windows logo key+ R" and then plug the Digispark in  the suspects usb port. Also the script restarts again in Win7  so unplug it before a new run. In Windows 10 it runs just once as expected and coded. <br/>
Windows 7 support ends in January 2020. ;-) <br/>
